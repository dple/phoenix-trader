...
const execute = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (setupNewMakerIxs.length !== 0) {
        const setup = new web3_js_2.Transaction().add(...setupNewMakerIxs);
        const setupTxId = yield (0, web3_js_2.sendAndConfirmTransaction)(connection, setup, [traderKeypair], {
            skipPreflight: true,
    ...
    // Cancel all outstanding order before quoting
    do {
        ...
        try {
            const cancelTransaction = new web3_js_2.Transaction().add(cancelAll);
            const txid = yield (0, web3_js_2.sendAndConfirmTransaction)(connection, cancelTransaction, [traderKeypair], {
                skipPreflight: true,
                commitment: "confirmed",
            });
        ...
        try {
            ...
            try {
                const placeQuotesTx = new web3_js_2.Transaction().add(...instructions);
                const placeQuotesTxId = yield (0, web3_js_2.sendAndConfirmTransaction)(connection, placeQuotesTx, [traderKeypair], {
                    skipPreflight: true,
                    commitment: "confirmed",
                });
